...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "character_class", sa.String(), nullable=False
        ),  # Added character_class
    ...
    op.create_table(
        ...
        sa.Column(
            "timestamp", sa.TIMESTAMP(), nullable=False, server_default=sa.func.now()
        ),  # Added timestamp column
        sa.ForeignKeyConstraint(
            ["cart_id"],
            [
                "carts.customer_id"
            ],  # Updated foreign key constraint to reference customer_id
        ),
        sa.PrimaryKeyConstraint("id"),
    )
